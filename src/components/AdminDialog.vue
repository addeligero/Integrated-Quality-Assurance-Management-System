...
<template>
	...
	<v-dialog v-model="addDialogModel" max-width="520" rounded="xl">
		<v-card rounded="xl" class="pa-6">
			...
			<div class="d-flex flex-column ga-4">
				<div>
					<label class="text-caption font-weight-bold text-grey-darken-3 d-block mb-1">Name Extension</label>
					<v-select
				...
				<div>
					...
					<v-text-field
						...
						color="deep-orange-darken-2"
					/>
					<p class="text-caption text-grey mt-1 ml-1">e.g. "Mary Rose Raz" -> <strong>mrraz</strong></p>
				</div>
				...
				<div>
					<label class="text-caption font-weight-bold text-grey-darken-3 d-block mb-1">Department</label>
					<v-text-field
	...
	<v-dialog v-model="editDialogModel" max-width="380" rounded="xl">
		<v-card v-if="props.editTarget" rounded="xl" class="pa-6">
			<v-card-title class="text-subtitle-1 font-weight-bold pa-0 mb-4">Edit Role & Access</v-card-title>
			<v-select
	...
	<v-dialog v-model="resetPasswordDialogModel" max-width="420" persistent>
		<v-card rounded="lg" class="pa-6">
			<template v-if="props.resetPasswordTarget">
				<v-card-title class="text-subtitle-1 font-weight-bold pa-0 mb-2">Reset Password</v-card-title>
				<p class="text-body-2 text-grey-darken-2 mb-5">
	...
	<v-dialog v-model="resetAllPasswordsDialogModel" max-width="420" persistent>
		<v-card rounded="lg" class="pa-6">
			<v-card-title class="text-subtitle-1 font-weight-bold pa-0 mb-2">Reset All Passwords</v-card-title>
			<p class="text-body-2 text-grey-darken-2 mb-5">
